...
export const VisitModal = ({
    ...
    const isoDate = (value: string) => {
        ...
        const aux = baseDate.toISOString();
                                    ...
                                    <FormItem>
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value="Otros Motivos">Otros Motivos</SelectItem>
                                            </SelectContent>
                                        </Select>
                                        <FormMessage />
                                    </FormItem>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <textarea className="border rounded-md px-4 py-2 text-sm" rows={4} {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
